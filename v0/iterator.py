...
from state import IdeaManager, Idea, IdeaStatus

async def run_research_loop(max_iterations, init_code_path, gpu_ids):
    ...
    if list(manager.nodes.values())[0].status == IdeaStatus.FAILED:
